...
通过上述方法可调试大部分适配，若部分机型适配有问题，可使用按照[调试文档](../../hybird/debug/README.md)来调试。
...
/**
 *
 * @param {*} routeName 路由 如 "shophome"
 * @param {*} params 参数 如 {id: 1}
 */
...
H5 无法对小程序发送除[微信小程序](https://developers.weixin.qq.com/miniprogram/dev/component/web-view.html)支持之外的消息。
...
君品荟小程序用于 uatt 环境。原始 id ：`gh_cd6c35c8fbd0`<br />
